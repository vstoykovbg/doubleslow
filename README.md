...
The script utilizes mnemonic code (RFC1751, BIP39) and checksums to prevent i/o human errors. The user enters the settings interactively in the first script (`doubleslow-base.py`), the settings for the next stage are encoded inside the mnemonic code (protected with checksums).
